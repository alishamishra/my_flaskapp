...
def CURRENTTITLE():
	...
	return render_template("tutorials/CURRENTTOPIC/
	CURRENTHTML",completed_percentages=completed_percentages, curLink = 
	TOPIC_DICT["CURRENTTOPIC"][CURRENTINDEX][1], curTitle=TOPIC_DICT["CURRENTTOPIC"][CURRENTINDEX][0], 
	nextLink = TOPIC_DICT["CURRENTTOPIC"][NEXTINDEX][1], nextTitle = TOPIC_DICT["CURRENTTOPIC"][NEXTINDEX][0])
